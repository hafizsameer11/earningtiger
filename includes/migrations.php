...
function runMigrations(): array {
    ...
    $messages[] = 'Default settings checked.';
    ...
    if ($pmCheck == 0) {
        ...
        $messages[] = 'Default payment methods added.';
    }

    if (!is_dir(UPLOAD_PATH)) {
        mkdir(UPLOAD_PATH, 0755, true);
    }
    if (!is_dir(PROOFS_UPLOAD_PATH)) {
        mkdir(PROOFS_UPLOAD_PATH, 0755, true);
    }
    $messages[] = 'Upload folders verified.';

    setSetting('migration_version', (string) MIGRATION_VERSION);
